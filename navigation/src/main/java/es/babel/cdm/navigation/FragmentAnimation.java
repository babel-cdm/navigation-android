...
public class FragmentAnimation {
    ...
    /**
     * Creates a partially completed fragment animation, only with enter and exit
     * animation plus Lollipop Animations
     *
     * @param enterAnim   Enter animaition
     * @param exitAnim    Exit animation
    ...
    /**
     * Creates a fully completed fragment animation, with all the required animations (enter,
     * exit, pop out of the stack
     ...
     * </ul>
     *
     * @return TRUE if any of the pop out animation of the push in animation are defined,
     * FALSE otherwise
     */
